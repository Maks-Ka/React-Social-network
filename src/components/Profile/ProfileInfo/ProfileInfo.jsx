...
const ProfileInfo = ({ profile, status, updateStatus, isOwner, savePhoto, saveProfile }) => {
  ...
  return (
    <div className={styles.Profile}>
      ...
      <img src='https://static6.depositphotos.com/1007728/659/i/600/depositphotos_6591354-stock-photo-long-mountain-panorama-of-lake.jpg' />
    </div> */}
      <div className={styles.descriptionBlock}>
        <img src={profile.photos.large || userPhoto} className={styles.mainPhoto} />
        {isOwner && <input type={"file"} className={styles.fileInsert} onChange={onMainPhotoSelected} />}
